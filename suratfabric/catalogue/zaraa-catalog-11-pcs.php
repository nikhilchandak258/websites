...
<?php
session_start();
$_SESSION['catname']="Zaraa"; // You can set the value however you like.
...
?>
	...
	<head>
        ...
        echo $contents; 
		?>
		<title>Zaraa Suit Catalog</title>
		<meta name="description" content="Buy online Zaraa Suit Catalogue 11 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Online, Zaraa, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/zaraa.csv", "r")) !== FALSE) {
