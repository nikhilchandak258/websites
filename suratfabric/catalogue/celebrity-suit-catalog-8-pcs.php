...
<?php
session_start();
$_SESSION['catname']="Celebrity"; // You can set the value however you like.

$title="Celebrity";
$description="";
$pieces="8";
$top="[Cotton/Chanderi/Net Brasso/Georgette] 2pcs each.";
$dupatta="Nazneen";
$bottom="Shantoon";
$inner="";
...
?>
	...
	<head>
        ...
        echo $contents; 
		?>
		<title>Celebrity Suit Catalog - Suratfabric.com</title>
		<meta name="description" content="Buy online Celebrity Suit Catalogue 11 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, suits, Celebrity, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/celebrity.csv", "r")) !== FALSE) {
