...
<?php
session_start();
$_SESSION['catname']="Vidhi-Vol-5"; // You can set the value however you like.
$title="Vidhi-Vol-5";
$description="";
$pieces="9";
$top="Pure Georgette";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Vidhi-Vol-5 Suit Catalog</title>
		<meta name="description" content="Buy online Vidhi Vol 5 Suit Catalogue 9 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Online, Vidhi, Vol-5, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/vidhivol5.csv", "r")) !== FALSE) {
