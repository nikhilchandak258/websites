...
<?php
session_start();
$_SESSION['catname']="LT Fabrics - Nithya Vol 44"; // You can set the value however you like.

$title="LT Fabrics - Nithya Vol 44";
$description="";
$pieces="12";
$top="Georgette";
$dupatta="Nazneen";
...
?>
	...
	<head>
        ...
        echo $contents; 
		?>
		<title>LT Fabrics-Nithya Vol 44 Suit Catalog - Suratfabric.com </title>
		<meta name="description" content="Buy LT Fabrics - Nithya Vol 44 Suit Catalogue 12 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, LT Fabrics, Nithya Vol 44, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/nithya44.csv", "r")) !== FALSE) {
