...
<?php
session_start();
$_SESSION['catname']="Panash"; // You can set the value however you like.
$title="Panash";
$description="";
$pieces="10";
$top="Cotton Cambric";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Panash Suit Catalog</title>
		<meta name="description" content="Buy online Panash Suit Catalogue 10 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Panash, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/panash.csv", "r")) !== FALSE) {
