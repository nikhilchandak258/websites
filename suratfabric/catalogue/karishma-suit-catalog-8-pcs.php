...
<?php
session_start();
$_SESSION['catname']="Karishma"; // You can set the value however you like.
...
?>
	...
	<head>
        ...
        echo $contents; 
		?>
		<title>Karishma Suit Catalog - Suratfabric.com</title>
		<meta name="description" content="Buy online Karishma Suit Catalogue 8 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Suits, Karishma, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/karishma.csv", "r")) !== FALSE) {
