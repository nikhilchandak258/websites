...
<?php
session_start();
$_SESSION['catname']="Glamour"; // You can set the value however you like.
$title="Glamour";
$description="";
$pieces="10";
$top="Cora silk";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Glamour Suit Catalog 10 pcs - Suratfabric.com</title>
		<meta name="description" content="Buy online Glamour Suit Catalogue 10 pcs at lowest Wholesale Prices:Suratfabric.com" />
		<meta name="keywords" content=" Buy, Suits, Glamour, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/glamour.csv", "r")) !== FALSE) {
