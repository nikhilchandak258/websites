...
<?php
session_start();
$_SESSION['catname']="Zubeda-Vol-10"; // You can set the value however you like.
$title="Zubeda-Vol-10";
$description="";
$pieces="11";
$top="Georgette";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Zubeda-Vol-10 Suit Catalog</title>
		<meta name="description" content="Buy online Zubeda Vol 10 Suit Catalogue 11 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Online, Zubeda Vol 10, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/akshara.csv", "r")) !== FALSE) {
