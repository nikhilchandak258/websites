...
<?php
session_start();
$_SESSION['catname']="Bluestar"; // You can set the value however you like.
$title="Bluestar";
$description="";
$pieces="20";
$top="Chanderi";
$dupatta="Nanzeen Fancy Dupatta";
$bottom="PC Cotton";
$inner="-";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Bluestar Suit Catalog 20 pcs - Suratfabric.com</title>
		<meta name="description" content="Buy Bluestar Suit Catalogue 20 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, suits, Bluestar, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/bluestar.csv", "r")) !== FALSE) {
