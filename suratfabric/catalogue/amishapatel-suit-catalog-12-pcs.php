...
<?php
session_start();
$_SESSION['catname']="Amisha Patel"; // You can set the value however you like.
...
?>
	...
	<head>
        ...
        echo $contents; 
		?>
		<title>Amisha Patel Suit Catalog - Suratfabric.com</title>
		<meta name="description" content="Buy online Amisha Patel Suit Catalogue 12 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Suits, Amisha Patel, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/amishapatel.csv", "r")) !== FALSE) {
