...
<?php
session_start();
$_SESSION['catname']="Garima"; // You can set the value however you like.

$title="Garima";
$description="";
$pieces="12";
$top="(Banaras+Chanderi) with nazneen sleeves";
$dupatta="Nazneen";
$bottom="Semi loan";
$inner="";
...
?>
	...
	<head>
        ...
        echo $contents; 
		?>
		<title>Garima Suit Catalog</title>
		<meta name="description" content="Buy online Garima Suit Catalogue 12 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Online, Garima, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/garima.csv", "r")) !== FALSE) {
