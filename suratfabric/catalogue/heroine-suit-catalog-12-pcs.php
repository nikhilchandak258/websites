...
<?php
session_start();
$_SESSION['catname']="Heroine"; // You can set the value however you like.
...
?>
	...
	<head>
        ...
        echo $contents; 
		?>
		<title>Heroine Suit Catalog - Suratfabric.com</title>
		<meta name="description" content="Buy online Heroine Suit Catalogue 12 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, suits, Heroine, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/heroine.csv", "r")) !== FALSE) {
