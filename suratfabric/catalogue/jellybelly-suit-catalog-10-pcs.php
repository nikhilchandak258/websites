...
<?php
session_start();
$_SESSION['catname']="JellyBelly"; // You can set the value however you like.
$title="JellyBelly";
$description="";
$pieces="10";
$top="Pure + Nett";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>JellyBelly Suit Catalog 10 pcs - Suratfabric.com</title>
		<meta name="description" content="Buy online JellyBelly Suit Catalogue 10 pcs at lowest Wholesale Prices:Suratfabric.com" />
		<meta name="keywords" content=" Buy, Suits, JellyBelly, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/jellybelly.csv", "r")) !== FALSE) {
