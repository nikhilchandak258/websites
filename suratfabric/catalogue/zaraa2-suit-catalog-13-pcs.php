...
<?php
session_start();
$_SESSION['catname']="Zaraa 2"; // You can set the value however you like.
...
?>
	...
	<head>
        ...
        echo $contents; 
		?>
		<title>Zaraa 2 Suit Catalog 12 pcs  - Suratfabric.com</title>
		<meta name="description" content="Buy online Zaraa 2 Suit Catalogue 12 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Suits, Zaraa2, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/zaraa2.csv", "r")) !== FALSE) {
