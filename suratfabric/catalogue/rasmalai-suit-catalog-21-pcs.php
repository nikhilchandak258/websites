...
<?php
session_start();
$_SESSION['catname']="Rasmalai"; // You can set the value however you like.
$title="Rasmalai";
$description="";
$pieces="21";
$top="Cotton";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Rasmalai Suit Catalog 21 pcs - Suratfabric.com</title>
		<meta name="description" content="Buy online Rasmalai Suit Catalogue 21  pcs at lowest Wholesale Prices:Suratfabric.com" />
		<meta name="keywords" content=" Buy, Suits, Rasmalai, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/rasmalai.csv", "r")) !== FALSE) {
