...
<?php
session_start();
$_SESSION['catname']="Rivaz"; // You can set the value however you like.
...
?>
	...
	<head>
        ...
        echo $contents; 
		?>
		<title>Rivaz Suit Catalog 4 pcs - Suratfabric.com</title>
		<meta name="description" content="Buy online Rivaz Suit Catalogue 4 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Suits, Rivaz, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/rivaz.csv", "r")) !== FALSE) {
