...
<?php
session_start();
$_SESSION['catname']="Kalyanam Vol-1"; // You can set the value however you like.
$title="Kalyanam Vol-1";
$description="";
$pieces="12";
$top="60 Gram";
$dupatta="Nazneen work";
$bottom="Shantoon";
$inner="Shantoon";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Kalyanam Vol-1 Suit Catalog</title>
		<meta name="description" content="Buy online Kalyanam Vol-1 Suit Catalogue 12 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Online, Kalyanam, Vol-1, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/kalyanam.csv", "r")) !== FALSE) {
