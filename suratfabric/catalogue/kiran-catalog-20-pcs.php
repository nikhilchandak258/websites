...
<?php
session_start();
$_SESSION['catname']="Kiran"; // You can set the value however you like.
$title="Kiran";
$description="";
$pieces="20";
$top="Pure Cotton";
$dupatta="Pure Cotton Mal Dupatta";
$bottom="Pure Cotton";
$inner="-";
$range="Below Rs.500";
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Kiran Suit Catalog</title>
		<meta name="description" content="Buy online Kiran Suit Catalogue 20 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Online, Kiran, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/kiran.csv", "r")) !== FALSE) {
