...
<?php
session_start();
$_SESSION['catname']="Hollywood Anarkali"; // You can set the value however you like.
$title="Hollywood Anarkali";
$description="";
$pieces="8";
$top="Georgette";
$dupatta="Nazneen";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Hollywood Anarkali Suit Catalog</title>
		<meta name="description" content="Buy online Hollywood Anarkali Suit Catalogue 9 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Online, Hollywood, Anarkali, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/georgetto.csv", "r")) !== FALSE) {
