...
<?php
session_start();
$_SESSION['catname']="Aaisha Heavy Cotton"; // You can set the value however you like.

$title="Aaisha Heavy Cotton";
$description="";
$pieces="8";
$top="60 Gram";
$dupatta="Nazneen";
...
?>
	...
	<head>
        ...
        echo $contents; 
		?>
		<title>Aaisha Heavy Cotton Suit Catalog 8 pcs - Suratfabric.com</title>
		<meta name="description" content="Buy online Aaisha Heavy Cotton Suit Catalogue 8 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Suits, Aaisha Heavy Cotton , Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/ayeshaheavycotton.csv", "r")) !== FALSE) {
