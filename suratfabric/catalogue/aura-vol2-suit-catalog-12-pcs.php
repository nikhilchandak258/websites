...
<?php
session_start();
$_SESSION['catname']="Aura Vol 2"; // You can set the value however you like.
...
?>
	...
	<head>
        ...
        echo $contents; 
		?>
		<title>Aura vol2 Suit Catalog - Suratfabric.com</title>
		<meta name="description" content="Buy online Aura vol2 Suit Catalogue 12 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Suits, Aura vol2, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/auravo12.csv", "r")) !== FALSE) {
