...
<?php
session_start();
$_SESSION['catname']="Madhubala"; // You can set the value however you like.
$title="Madhubala";
$description="";
$pieces="12";
$top="60 Gram";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Madhubala Suit Catalog</title>
		<meta name="description" content="Madhubala Suit Catalogue buy online 12 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, suit, madhubala, Catalog, wholesale, catalogue, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/madhubala.csv", "r")) !== FALSE) {
