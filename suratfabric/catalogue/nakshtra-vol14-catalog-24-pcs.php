...
<?php
session_start();
$_SESSION['catname']="Nakshtra Vol 14"; // You can set the value however you like.
$title="Nakshtra Vol 14";
$description="";
$pieces="24";
$top="Leon";
$dupatta="Silver Shiffon";
$bottom="Leon";
$inner="";
$range="Below Rs.500";
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Nakshtra Vol 14 Suit Catalog</title>
		<meta name="description" content="Nakshtra Vol 14 Suit Catalogue buy online 24 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, suit, Nakshtra Vol 14, Catalog, wholesale, catalogue, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/nakshtravol14.csv", "r")) !== FALSE) {
