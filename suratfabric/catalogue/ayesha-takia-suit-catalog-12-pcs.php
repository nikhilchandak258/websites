...
<?php
session_start();
$_SESSION['catname']="Ayesha Takia"; // You can set the value however you like.
...
?>
	...
	<head>
        ...
        echo $contents; 
		?>
		<title>Ayesha Takia Suit Catalog - Suratfabric.com </title>
		<meta name="description" content="Buy Ayesha Takia Suit Catalogue 12 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Ayesha Takia, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/ayeshatakia.csv", "r")) !== FALSE) {
