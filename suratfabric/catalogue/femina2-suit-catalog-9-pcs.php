...
<?php
session_start();
$_SESSION['catname']="Femina2"; // You can set the value however you like.
...
?>
	...
	<head>
        ...
        echo $contents; 
		?>
		<title>Femina2 Suit Catalog - Suratfabric.com</title>
		<meta name="description" content="Buy online Femina2 Suit Catalogue 9 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Suits, Femina2, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/femina.csv", "r")) !== FALSE) {
