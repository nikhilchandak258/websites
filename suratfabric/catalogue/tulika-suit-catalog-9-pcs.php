...
<?php
session_start();
$_SESSION['catname']="Tulika"; // You can set the value however you like.
$title="Tulika";
$description="";
$pieces="9";
$top="Georgette";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Tulika Suit 9 pcs Catalog</title>
		<meta name="description" content="Buy online Tulika Suit Catalogue 9 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Online, Tulika, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/tulika.csv", "r")) !== FALSE) {
