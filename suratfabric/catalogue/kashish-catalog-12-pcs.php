...
<?php
session_start();
$_SESSION['catname']="Kashish"; // You can set the value however you like.
...
?>
	...
	<head>
        ...
        echo $contents; 
		?>
		<title>Kashish Suit Catalog - Suratfabric.com</title>
		<meta name="description" content="Buy Suit Kashish Catalogue 11 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Suits, Kashish, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/kashish.csv", "r")) !== FALSE) {
