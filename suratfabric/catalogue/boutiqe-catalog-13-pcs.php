...
<?php
session_start();
$_SESSION['catname']="Boutiqe"; // You can set the value however you like.
$title="Boutiqe";
$description="";
$pieces="13";
$top="Cotton";
$dupatta="Shiffon Dupatta";
$bottom="Cotton";
$inner="-";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Boutiqe Suit Catalog</title>
		<meta name="description" content="Buy online Boutiqe Suit Catalogue 13 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Online, Boutiqe, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/botiqe.csv", "r")) !== FALSE) {
