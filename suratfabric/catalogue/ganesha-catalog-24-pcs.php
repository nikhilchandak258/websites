...
<?php
session_start();
$_SESSION['catname']="Ganesha"; // You can set the value however you like.
$title="Ganesha";
$description="";
$pieces="24";
$top="Cotton";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Ganesha Suit Catalog</title>
		<meta name="description" content="Buy online Ganesha Suit Catalogue 24 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Online, Ganesha, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/ganesha.csv", "r")) !== FALSE) {
