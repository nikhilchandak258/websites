...
<?php
session_start();
$_SESSION['catname']="Kangan-Vol-1"; // You can set the value however you like.
$title="Kangan-Vol-1";
$description="";
$pieces="20";
$top="American";
...
?>
	<head>
		...
		<title>Kangan-Vol-1 Suit Catalog</title>
		<meta name="description" content="Buy online Kangan-Vol-1 Suit Catalogue 20 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Online, Kangan, Vol-1, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/kangan.csv", "r")) !== FALSE) {
