...
<?php
session_start();
$_SESSION['catname']="Browani"; // You can set the value however you like.
$title="Browani";
$description="";
$pieces="12";
$top="Cotton With Shiffon sleeves";
$dupatta="Shiffon";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Browani Suit Catalog</title>
		<meta name="description" content="Buy online Browani Suit Catalogue 12 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Online, Browani, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/browani.csv", "r")) !== FALSE) {
