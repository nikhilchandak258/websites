...
<?php
session_start();
$_SESSION['catname']="Meenar"; // You can set the value however you like.
$title="Meenar";
$description="";
$pieces="8";
$top="Georgette";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Meenar Suit Catalog 8 pcs - Suratfabric.com</title>
		<meta name="description" content="Buy online Meenar Suit Catalogue 8 pcs at lowest Wholesale Prices:Suratfabric.com" />
		<meta name="keywords" content=" Buy, Suits, Meenar, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/meenar.csv", "r")) !== FALSE) {
