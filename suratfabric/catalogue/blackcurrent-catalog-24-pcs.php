...
<?php
session_start();
$_SESSION['catname']="Blackcurrent"; // You can set the value however you like.

$title="Blackcurrent";
$description="";
$pieces="24";
$top="Cotton";
$dupatta="100% Cotton Mal Dupatta";
$bottom="Cotton";
$inner="-";
$range="Below Rs.500";
...
?>
	...
	<head>
        ...
        echo $contents; 
		?>
		<title>Blackcurrent Suit Catalog</title>
		<meta name="description" content="Buy online Blackcurrent Suit Catalogue 24 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Online, Blackcurrent, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/blackcurrent.csv", "r")) !== FALSE) {
