...
<?php
session_start();
$_SESSION['catname']="Eliana"; // You can set the value however you like.
...
?>
	...
	<head>
        ...
        echo $contents; 
		?>
		<title>Eliana Suit Catalog - Suratfabric.com</title>
		<meta name="description" content="Buy online Eliana Suit Catalogue 12 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, suits, Eliana, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/eliana.csv", "r")) !== FALSE) {
