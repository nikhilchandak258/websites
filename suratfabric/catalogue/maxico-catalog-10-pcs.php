...
<?php
session_start();
$_SESSION['catname']="Maxico"; // You can set the value however you like.
...
?>
	...
	<head>
        ...
        echo $contents; 
		?>
		<title>Maxico Suit Catalog</title>
		<meta name="description" content="Buy online Maxico Suit Catalogue 8 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Online, Maxico, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/maxico.csv", "r")) !== FALSE) {
