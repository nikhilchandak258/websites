...
<?php
session_start();
$_SESSION['catname']="Rise-3"; // You can set the value however you like.
$title="Rise-3";
$description="";
$pieces="16";
$top="Spun Cotton";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Rise-3 Suit Catalog 15 pcs - Suratfabric.com</title>
		<meta name="description" content="Buy online Rise-3 Suit Catalogue 16 pcs at lowest Wholesale Prices:Suratfabric.com" />
		<meta name="keywords" content=" Buy, Suits, Rise-3, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/rise3.csv", "r")) !== FALSE) {
