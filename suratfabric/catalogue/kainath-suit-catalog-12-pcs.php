...
<?php
session_start();
$_SESSION['catname']="kainath"; // You can set the value however you like.
$title="kainath";
$description="";
$pieces="12";
$top="Georgette";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>kainath Suit Catalog 12 pcs - Suratfabric.com</title>
		<meta name="description" content="Buy online kainath Suit Catalogue 12 pcs at lowest Wholesale Prices:Suratfabric.com" />
		<meta name="keywords" content=" Buy, Suits, kainath, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/kainath.csv", "r")) !== FALSE) {
