...
<?php
session_start();
$_SESSION['catname']="Sangam"; // You can set the value however you like.
$title="Sangam";
$description="";
$pieces="12";
$top="Marbal Jacquard";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Sangam Suit Catalog 12 pcs - Suratfabric.com</title>
		<meta name="description" content="Buy Sangam Suit Catalogue 12pcs at lowest Wholesale Prices:Suratfabric.com" />
		<meta name="keywords" content=" Buy, suits, Sangam, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/sangam.csv", "r")) !== FALSE) {
