...
<?php
session_start();
$_SESSION['catname']="Aayat"; // You can set the value however you like.
$title="Aayat";
$description="";
$pieces="6";
$top="";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Aayat Suit Catalog 6 pcs - Suratfabric.com</title>
		<meta name="description" content="Buy online Aayat Suit Catalogue 6 pcs at lowest Wholesale Prices:Suratfabric.com" />
		<meta name="keywords" content=" Buy, Suits, Aayat, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/aayat.csv", "r")) !== FALSE) {
