...
<?php
session_start();
$_SESSION['catname']="Shagun"; // You can set the value however you like.
$title="Shagun";
$description="";
$pieces="12";
$top="60 Gram";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Shagun Suit Catalog</title>
		<meta name="description" content="Shagun Suit Catalogue buy online 12 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, suit, Shagun, Catalog, wholesale, catalogue, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/shagun.csv", "r")) !== FALSE) {
