...
<?php
session_start();
$_SESSION['catname']="Zahra"; // You can set the value however you like.
...
?>
	...
	<head>
        ...
        echo $contents; 
		?>
		<title>Zahra Suit Catalog 10 pcs - Suratfabric.com</title>
		<meta name="description" content="Buy online Zahra Suit Catalogue 10 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Suits, Zahra, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/zahra.csv", "r")) !== FALSE) {
