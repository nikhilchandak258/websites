...
<?php
session_start();
$_SESSION['catname']="Swastik Vol 13"; // You can set the value however you like.
$title="Swastik Vol 13";
$description="";
$pieces="24";
$top="American";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Swastik Vol 13 Suit Catalog</title>
		<meta name="description" content="Swastik Vol 13 Suit Catalogue buy online 24 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, suit, Swastik Vol 13, Catalog, wholesale, catalogue, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/swastikvol13.csv", "r")) !== FALSE) {
