...
<?php
session_start();
$_SESSION['catname']="Queen"; // You can set the value however you like.
$title="Queen";
$description="";
$pieces="7";
$top="Cotton";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Queen Suit Catalog</title>
		<meta name="description" content="Buy Queen Suit Catalogue 7 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Online, Queen, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/queen.csv", "r")) !== FALSE) {
