...
<?php
session_start();
$_SESSION['catname']="Zubeda Vol 12"; // You can set the value however you like.
...
?>
	...
	<head>
        ...
        echo $contents; 
		?>
		<title>Zubeda Vol 12 Suit Catalog - Suratfabric.com</title>
		<meta name="description" content="Buy online Zubeda Vol 12 Suit Catalogue 8 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Suits, Zubeda Vol 12, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/zubedavol12.csv", "r")) !== FALSE) {
