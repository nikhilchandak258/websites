...
<?php
session_start();
$_SESSION['catname']="Elegant"; // You can set the value however you like.
$title="Elegant";
$description="";
$pieces="12";
$top="60 Gram";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Elegant Suit Catalog</title>
		<meta name="description" content="Buy online Elegant Suit Catalogue 12 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Elegant, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/elegant.csv", "r")) !== FALSE) {
