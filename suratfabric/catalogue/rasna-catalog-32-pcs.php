...
<?php
session_start();
$_SESSION['catname']="Rasna"; // You can set the value however you like.
$title="Rasna";
$description="";
$pieces="32";
$top="Cotton";
$dupatta="100% Pure Cotton Mal Dupatta";
$bottom="Cotton";
$inner="-";
$range="Below Rs.500";
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Rasna Suit Catalog</title>
		<meta name="description" content="Buy online Rasna Suit Catalogue 32 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Online, Rasna, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/rasna.csv", "r")) !== FALSE) {
