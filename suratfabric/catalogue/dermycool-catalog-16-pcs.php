...
<?php
session_start();
$_SESSION['catname']="Dermy Cool"; // You can set the value however you like.

$title="Dermy Cool";
$description="";
$pieces="16";
$top="Chanderi";
$dupatta="Printed Nazneen";
$bottom="Indo Cotton";
$inner="";
$range="Below Rs.500";
...
?>
	...
	<head>
        ...
        echo $contents; 
		?>
		<title>Dermy Cool Suit Catalog - Suratfabric.com</title>
		<meta name="description" content="Buy Suit Dermy Cool Catalogue 11 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Suits, Savera Vol-3, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/dermycool.csv", "r")) !== FALSE) {
