...
<?php
session_start();
$_SESSION['catname']="Sakshi"; // You can set the value however you like.
...
?>
	...
	<head>
        ...
        echo $contents; 
		?>
		<title>Sakshi Suit Catalog</title>
		<meta name="description" content="Buy online Sakshi Suit Catalogue 9 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Online, Sakshi, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/sakshi.csv", "r")) !== FALSE) {
