...
<?php
session_start();
$_SESSION['catname']="Sarkaar"; // You can set the value however you like.
$title="Sarkaar";
$description="";
$pieces="10";
$top="Banarasi";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Sarkaar Suit Catalog 10 pcs - Suratfabric.com</title>
		<meta name="description" content="Buy Sarkaar Suit Catalogue 10 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, suits, Sarkaar, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/sarkaar.csv", "r")) !== FALSE) {
