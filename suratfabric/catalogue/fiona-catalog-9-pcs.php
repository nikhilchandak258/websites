...
<?php
session_start();
$_SESSION['catname']="Fiona"; // You can set the value however you like.
$title="Fiona";
$description="";
$pieces="9";
$top="100% Cotton";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Fiona Suit Catalog</title>
		<meta name="description" content="Buy Fiona Suit Catalogue 9 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Online, Fiona, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/fiona.csv", "r")) !== FALSE) {
