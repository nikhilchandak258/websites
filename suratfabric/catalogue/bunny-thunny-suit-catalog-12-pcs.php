...
<?php
session_start();
$_SESSION['catname']="Bunny Thunny"; // You can set the value however you like.
$title="Bunny Thunny";
$description="";
$pieces="12";
$top="60 Gram";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Bunny Thunny Suit Catalog</title>
		<meta name="description" content="Buy online Bunny Thunny Suit Catalogue 12 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Online, Bunny Thunny, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/bunnythunny.csv", "r")) !== FALSE) {
