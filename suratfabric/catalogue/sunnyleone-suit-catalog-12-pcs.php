...
<?php
session_start();
$_SESSION['catname']="Sunnyleone"; // You can set the value however you like.
...
?>
	...
	<head>
        ...
        echo $contents; 
		?>
		<title>Sunnyleone Suit Catalog - Suratfabric.com</title>
		<meta name="description" content="Buy online Sunnyleone Suit Catalogue 12 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Suits, Sunnyleone, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/sunnyleone.csv", "r")) !== FALSE) {
