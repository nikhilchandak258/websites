...
<?php
session_start();
$_SESSION['catname']="Savera Vol 3"; // You can set the value however you like.
...
?>
	...
	<head>
        ...
        echo $contents; 
		?>
		<title>Savera Vol-3 Suit Catalog</title>
		<meta name="description" content="Buy online Savera Vol-3 Suit Catalogue 11 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Online, Savera Vol-3, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/savera3.csv", "r")) !== FALSE) {
