...
<?php
session_start();
$_SESSION['catname']="Dimpal"; // You can set the value however you like.
$title="Dimpal";
$description="";
$pieces="12";
$top="Georgette";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Dimpal Suit Catalog 12 pcs - Suratfabric.com</title>
		<meta name="description" content="Buy online Dimpal Suit Catalogue 12 pcs at lowest Wholesale Prices:Suratfabric.com" />
		<meta name="keywords" content=" Buy, Suits, Dimpal, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/dimpal.csv", "r")) !== FALSE) {
