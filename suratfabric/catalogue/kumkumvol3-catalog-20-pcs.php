...
<?php
session_start();
$_SESSION['catname']="Kumkum-Vol-3"; // You can set the value however you like.
$title="Kumkum-Vol-3";
$description="";
$pieces="20";
$top="100% Cotton";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Kumkum-Vol-3 Suit Catalog</title>
		<meta name="description" content="Buy online Kumkum-Vol-3 Suit Catalogue 20 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Online, Kumkum, Vol-3, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/kumkum.csv", "r")) !== FALSE) {
