...
<?php
session_start();
$_SESSION['catname']="Chanchalpari"; // You can set the value however you like.
$title="Chanchalpari";
$description="";
$pieces="16";
$top="Spun Cotton";
$dupatta="Sliver Shiffon";
$bottom="Spun Cotton";
$inner="-";
$range="Below Rs.500";
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Chanchalpari Suit Catalog</title>
		<meta name="description" content="Buy online Chanchalpari Suit Catalogue 16 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Online, Chanchalpari, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/chanchalpari.csv", "r")) !== FALSE) {
