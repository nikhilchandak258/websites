...
<?php
session_start();
$_SESSION['catname']="Raaga"; // You can set the value however you like.
$title="Raaga";
$description="";
$pieces="10";
$top="Cotton";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Raaga Suit Catalog</title>
		<meta name="description" content="Buy online Raaga Suit Catalogue 10 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Online, Raaga, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/raga.csv", "r")) !== FALSE) {
