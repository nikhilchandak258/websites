...
<?php
session_start();
$_SESSION['catname']="Alvira"; // You can set the value however you like.
...
?>
	...
	<head>
        ...
        echo $contents; 
		?>
		<title>Alvira Suit Catalog - Suratfabric.com</title>
		<meta name="description" content="Buy online Alvira Suit Catalogue 10 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Suits, Alvira, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/alvira.csv", "r")) !== FALSE) {
