...
<?php
session_start();
$_SESSION['catname']="Antra Vol 2"; // You can set the value however you like.
$title="Antra Vol 2";
$description="";
$pieces="16";
$top="Chanderi";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Antra Vol 2 Suit Catalog</title>
		<meta name="description" content="Buy online Antra Vol 2 Suit Catalogue 16 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Online, Antra Vol 2, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/antravol2.csv", "r")) !== FALSE) {
