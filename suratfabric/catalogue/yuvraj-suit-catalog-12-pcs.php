...
<?php
session_start();
$_SESSION['catname']="Yuvraj"; // You can set the value however you like.
...
?>
	...
	<head>
        ...
        echo $contents; 
		?>
		<title>Yuvraj Suit Catalog - Suratfabric.com</title>
		<meta name="description" content="Buy online Yuvraj Suit Catalogue 12 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, suits, Yuvraj, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/yuvraj.csv", "r")) !== FALSE) {
