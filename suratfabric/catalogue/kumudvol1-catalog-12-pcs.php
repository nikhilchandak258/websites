...
<?php
session_start();
$_SESSION['catname']="Kumud Vol-1"; // You can set the value however you like.
$title="Kumud Vol-1";
$description="";
$pieces="12";
$top="60 Gram/Net/Georgette";
$dupatta="Nazneen";
$bottom="Shantton";
$inner="Shantoon";
$range="Above Rs.1500";
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Kumud Vol-1 Suit Catalog</title>
		<meta name="description" content="Buy online Kumud Vol-1 Suit Catalogue 12 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Online, Kumud, Vol-1, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/kumud.csv", "r")) !== FALSE) {
