...
<?php
session_start();
$_SESSION['catname']="Shakira"; // You can set the value however you like.
...
?>
	...
	<head>
        ...
        echo $contents; 
		?>
		<title>Shakira Suit Catalog 12 pcs - Suratfabric.com</title>
		<meta name="description" content="Buy online Shakira Suit Catalogue 12 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Suits, Shakira, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/shakira.csv", "r")) !== FALSE) {
