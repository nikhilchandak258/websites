...
<?php
session_start();
$_SESSION['catname']="Ramzaan"; // You can set the value however you like.
$title="Ramzaan";
$description="";
$pieces="13";
$top="60 Gram";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Ramzaan Suit Catalog</title>
		<meta name="description" content="Ramzaan Suit Catalogue buy online 13 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, suit, Ramzaan, Catalog, wholesale, catalogue, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/ramzaan.csv", "r")) !== FALSE) {
