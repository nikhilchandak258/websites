...
<?php
session_start();
$_SESSION['catname']="Bella"; // You can set the value however you like.
$title="Bella";
$description="";
$pieces="9";
$top="100% Cotton";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Bella Suit Catalog</title>
		<meta name="description" content="Buy online Bella Suit Catalogue 9 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Online, Bella, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/bella.csv", "r")) !== FALSE) {
