...
<?php
session_start();
$_SESSION['catname']="Sushmita"; // You can set the value however you like.
...
?>
	...
	<head>
        ...
        echo $contents; 
		?>
		<title>Sushmita Suit Catalog</title>
		<meta name="description" content="Buy online Sushmita Suit Catalogue 12 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Online, Sushmita, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/sushmita.csv", "r")) !== FALSE) {
