...
<?php
session_start();
$_SESSION['catname']="Kesar"; // You can set the value however you like.
$title="Kesar";
$description="";
$pieces="16";
$top="Chirag Cotton";
$dupatta="Shiffon";
$bottom="Chirag Cotton";
$inner="-";
$range="Below Rs.500";
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Kesar Suit Catalog 16 pcs - Suratfabric.com</title>
		<meta name="description" content="Buy online Kesar Suit Catalogue 16 pcs at lowest Wholesale Prices:Suratfabric.com" />
		<meta name="keywords" content=" Buy, Suits, Kesar, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/kesar.csv", "r")) !== FALSE) {
