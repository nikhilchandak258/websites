...
<?php
session_start();
$_SESSION['catname']="Priyanka"; // You can set the value however you like.
$title="Priyanka";
$description="";
$pieces="9";
$top="60 Gram/Net Brasso/Bamber";
$dupatta="Nazneen";
$bottom="Shantoon";
$inner="Shantoon";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Priyanka Suit Catalog</title>
		<meta name="description" content="Buy online Priyanka Suit Catalogue 9 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Priyanka, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/priyanka.csv", "r")) !== FALSE) {
