...
<?php
session_start();
$_SESSION['catname']="Karizma"; // You can set the value however you like.
$title="Karizma";
$description="";
$pieces="12";
$top="60 Gram";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Karizma Suit Catalog</title>
		<meta name="description" content="Karizma Suit Catalogue buy online 12 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, suit, Karizma, Catalog, wholesale, catalogue, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/karizma.csv", "r")) !== FALSE) {
