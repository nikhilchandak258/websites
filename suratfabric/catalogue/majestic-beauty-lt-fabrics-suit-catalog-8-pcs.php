...
<?php
session_start();
$_SESSION['catname']="LT Fabrics - Majestic Beauty"; // You can set the value however you like.

$title="LT Fabrics - Majestic Beauty";
$description="";
$pieces="8";
$top="Georgette";
$dupatta="Nazneen";
...
?>
	...
	<head>
        ...
        echo $contents; 
		?>
		<title>LT Fabrics-Majestic Beauty Suit Catalog - Suratfabric.com </title>
		<meta name="description" content="Buy LT Fabrics - Majestic Beauty Suit Catalogue 8 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, LT Fabrics, Majestic Beauty, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/majesticbeauty.csv", "r")) !== FALSE) {
