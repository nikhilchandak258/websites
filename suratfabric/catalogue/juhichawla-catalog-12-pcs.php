...
<?php
session_start();
$_SESSION['catname']="Juhi Chawla"; // You can set the value however you like.
$title="Juhichawla";
$description="";
$pieces="12";
$top="60 Gram Georgette";
$dupatta="Nazneem";
$bottom="Shantoon";
$inner="Shantoon";
...
?>
	...
	<head>
        ...
        echo $contents; 
		?>
		<title>Juhi Chawla Suit Catalog - Suratfabric.com</title>
		<meta name="description" content="Buy online Juhi Chawla Suit Catalogue 12 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Suits, Juhi Chawla, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/juhichawla.csv", "r")) !== FALSE) {
