...
<?php
session_start();
$_SESSION['catname']="Ghumar"; // You can set the value however you like.
$title="Ghumar";
$description="";
$pieces="20";
$top="Cotton";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Ghumar Suit Catalog 20 pcs - Suratfabric.com</title>
		<meta name="description" content="Buy online Ghumar Suit Catalogue 16 pcs at lowest Wholesale Prices:Suratfabric.com" />
		<meta name="keywords" content=" Buy, Suits, Ghumar, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/ghumar.csv", "r")) !== FALSE) {
