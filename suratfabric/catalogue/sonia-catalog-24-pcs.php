...
<?php
session_start();
$_SESSION['catname']="Sonia"; // You can set the value however you like.
$title="Sonia";
$description="";
$pieces="24";
$top="Cotton";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Sonia Suit Catalog</title>
		<meta name="description" content="Buy online Sonia Suit Catalogue 24 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Online, Sonia, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/sonia.csv", "r")) !== FALSE) {
