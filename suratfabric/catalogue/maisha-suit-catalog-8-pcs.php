...
<?php
session_start();
$_SESSION['catname']="Maisha"; // You can set the value however you like.
$title="Maisha";
$description="";
$pieces="8";
$top="";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Maisha Suit Catalog 8 pcs - Suratfabric.com</title>
		<meta name="description" content="Buy online Maisha Suit Catalogue 8 pcs at lowest Wholesale Prices:Suratfabric.com" />
		<meta name="keywords" content=" Buy, Suits, Maisha, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/maisha.csv", "r")) !== FALSE) {
