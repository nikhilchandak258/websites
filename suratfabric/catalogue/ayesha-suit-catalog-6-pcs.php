...
<?php
session_start();
$_SESSION['catname']="Ayesha"; // You can set the value however you like.
...
?>
	...
	<head>
        ...
        echo $contents; 
		?>
		<title>Ayesha Suit Catalog 6 pcs - Suratfabric.com</title>
		<meta name="description" content="Buy online Ayesha Suit Catalogue 6 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Suits, Ayesha, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/ayesha6.csv", "r")) !== FALSE) {
