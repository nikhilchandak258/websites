...
<?php
session_start();
$_SESSION['catname']="Savera"; // You can set the value however you like.
$title="Savera";
$description="";
$pieces="10";
$top="60 Gram";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Savera Suit Catalog</title>
		<meta name="description" content="Buy online Savera Suit Catalogue 10 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Online, Savera, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/savera.csv", "r")) !== FALSE) {
