...
<?php
session_start();
$_SESSION['catname']="Katha Vol-11"; // You can set the value however you like.
$title="Katha Vol-11";
$description="";
$pieces="12";
$top="Cotton";
...
?>
	<head>
        ...
        echo $contents; 
		?>
		<title>Katha Vol-11 Suit Catalog</title>
		<meta name="description" content="Buy online Katha Vol-11 Suit Catalogue 12 pcs at lowest Wholesale Prices" />
		<meta name="keywords" content=" Buy, Online, Katha, Vol-11, Suit, wholesale, catalogue, catalog, catlog, catlogue, wholesale price, lowest price" />
...
if (($handle = fopen("excel/katha.csv", "r")) !== FALSE) {
